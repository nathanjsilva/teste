    ...
    <div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="modalFormLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="panel-body">
                    <div class="mb-3">
                        ...
                        >Nome Cliente:</label
                        >
                        <input type="text" class="form-control" name="nome_cliente" id="nome_cliente" v-model="nome_cliente"/>
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Documento Cliente:</label>
                        <input type="text" class="form-control" name="documento_cliente" id="documento_cliente" v-model="documento_cliente"/>
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Nome Sanduíche</label>
                        <select v-model="nome_sanduiche" class="form-select">
                    ...
                    <div class="mb-3"> 
                        ...
                        <input type="text" class="form-control" name="qtd_sanduiche" id="recipient-name" v-model="qtd_sanduiche" />
                    </div>
                    <div class="mb-3"> 
                        <label for="recipient-name" class="col-form-label" >Valor Sanduiche:</label> 
                        <input type="text" class="form-control" name="valor_sanduiche" id="recipient-name" v-model="valor_sanduiche"/>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Enviar Pedido</button>
            </div>
            </form>
        </div>
        </div>
